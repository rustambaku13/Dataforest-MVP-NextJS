...
function Tasks(props) {
    ...
    const [orderType, setOrderType] = useState("image");
    const state = {
        visible: false
    };
    const {
    ...
    return (<> < TopHeader /> <FilterContainer>
        <Option>
            <div>
                <h3>Search</h3>
                <Input
                ...
                <Form onSubmit={handleSubmit} layout="vertical">
                    <Drawer
                        ...
                        <Modal
                            ...
                            title="Add New Label"
                            footer={[<Button key="submit" onClick={addLabel} type="primary">
                                Submit
                            </Button>
                                ]}>
                            <Form>
                                <Row>
                                    ...
                                    <Col span={24}>
                                        <Form.Item label="Description of label">
                                            {getFieldDecorator(`newLabelDesc`, {})(<TextArea   autoSize={{
                                                minRows: 2,
                                                maxRows: 8
                                            }}></TextArea>)}
                                        </Form.Item>
                                    ...
                                    <Col span={14}>
                                      <Form.Item label="Annotation Type" style={{"display":getFieldValue("newLabelHas")?"initial":"none"}}>
                                      {
                                        getFieldDecorator('newLabelAnnotation',{
                                          rules:[
                                            {
                                              required:(getFieldValue("newLabelHas")==true),
